...
public enum LegalDocumentType { Agb, Datenschutz, Vertrag, Sonstiges }
...
// === Subscriptions ===
public enum SubscriptionStatus { Active, Paused, Cancelled, Expired, PendingConfirmation, Completed }
